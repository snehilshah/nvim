-- cosmic-gleam (Dusk variant): gruvbox-material hard contrast, warm twilight
-- Deepest background, slightly punchier accents — for evening focus sessions.
...
vim.g.colors_name = "cosmic-gleam-dusk"

local colors = {
    -- Backgrounds (gruvbox-material hard, warm dark)
    ...
    -- Foregrounds (warm cream against deep bg)
    fg                 = "#ebdbb2", -- gruvbox classic cream
    fg_dim             = "#d4be98",
    grey0              = "#7c6f64",
    grey1              = "#928374",
    grey2              = "#a89984",

    -- Accents (gruvbox-material medium, easy on the eyes)
    red                = "#ea6962",
    orange             = "#e78a4e",
    yellow             = "#d8a657",
    green              = "#a9b665",
    ...
    -- Brighter set: gruvbox-original-leaning for evening punch
    bright_red         = "#fb4934",
    bright_green       = "#b8bb26",
    ...
    cursor_line        = "#282828",
    line_nr            = "#665c54",
    line_nr_active     = "#fabd2f",
    comment            = "#7c6f64",
    nontext            = "#665c54",
    sign_column        = "#1d2021",

    -- Pmenu / floats (slightly elevated above bg)
    menu_bg            = "#282828",
    menu_sel           = "#3c3836",
...
local groups = vim.tbl_extend("error", statusline_groups, {
    ...
    ["@comment.warning"]          = { fg = colors.bright_yellow, bold = true },
