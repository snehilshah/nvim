return {
	{
		...
		config = function()
			...
			-- changing background to "soft" from hard
				...
				highlight_overrides = {
					all = function(colors)
						return {
							...
							-- Inline diff highlights (exact changes within hunks)
							-- Darker shades for the exact text that changed
							DiffAdd = { bg = "#2d4a3e" }, -- dark green background for added lines
							DiffChange = { bg = "#3a3a2a" }, -- dark yellow/olive background for changed lines
							DiffDelete = { bg = "#4a2d2d" }, -- dark red background for deleted lines
							DiffText = { bg = "#5a3a3a" }, -- darker red for the exact changed text within a line

							-- GitSigns inline/word diff highlights (word-level changes)
							GitSignsAddInline = { fg = colors.green, bg = "#2d5a3e", bold = true }, -- green for added words
							GitSignsDeleteInline = { fg = colors.red, bg = "#5a2d2d", bold = true }, -- red for deleted words
							GitSignsChangeInline = { fg = colors.yellow, bg = "#5a4a2d", bold = true }, -- yellow for changed words

							GitSignsAddLnInline = { fg = colors.green, bg = "#2d5a3e", bold = true },
							GitSignsChangeLnInline = { fg = colors.yellow, bg = "#5a4a2d", bold = true },
							GitSignsDeleteLnInline = { fg = colors.red, bg = "#5a2d2d", bold = true },

							-- Virtual line diff highlights (for preview_hunk_inline and show_deleted)
							GitSignsDeleteVirtLn = { bg = "#3a2020" }, -- background for deleted virtual lines
							GitSignsDeleteVirtLnInLine = { fg = colors.red, bg = "#6a3030", bold = true }, -- word diff in virtual lines (RED)
							GitSignsAddVirtLnInline = { fg = colors.green, bg = "#306a30", bold = true }, -- word diff for added (GREEN)
							GitSignsChangeVirtLnInline = { fg = colors.yellow, bg = "#5a5a20", bold = true },

							-- Added/Removed text highlights (used by some diff views)
							Added = { fg = colors.green, bg = "#2d4a3e" },
							Removed = { fg = colors.red, bg = "#4a2d2d" },
							Changed = { fg = colors.yellow, bg = "#3a3a2a" },
