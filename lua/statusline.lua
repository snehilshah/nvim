...
-- Hoisted static table for mode mapping to optimize render performance
...
-- Hoisted static table for special filetype icons to optimize render performance
local special_icons = {
...
-- Hoisted static table for diagnostic severities using integer indices for Neovim 0.12+ compatibility
local severities = {
