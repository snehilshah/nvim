...
local severities = {
    { severity = sev.ERROR, icon = icons.diagnostics.ERROR },
    { severity = sev.WARN, icon = icons.diagnostics.WARN },
    { severity = sev.INFO, icon = icons.diagnostics.INFO },
    { severity = sev.HINT, icon = icons.diagnostics.HINT },
}
...
--- Wraps a statusline component with highlighting and styling.
