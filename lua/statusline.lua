...
local severities = {
    { severity = vim.diagnostic.severity and vim.diagnostic.severity.ERROR or 1, icon = icons.diagnostics.ERROR },
    { severity = vim.diagnostic.severity and vim.diagnostic.severity.WARN or 2, icon = icons.diagnostics.WARN },
    { severity = vim.diagnostic.severity and vim.diagnostic.severity.INFO or 3, icon = icons.diagnostics.INFO },
    { severity = vim.diagnostic.severity and vim.diagnostic.severity.HINT or 4, icon = icons.diagnostics.HINT },
}
