...
Neovim 0.12+ config. When changing keymaps, update `docs/keymaps.md`, if any external installation is required update `docs/install.md`. Whenever adding/modifying keymaps, make sure there are no conflicts.
