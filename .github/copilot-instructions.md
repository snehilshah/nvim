...
Neovim 0.11+ config. When changing keymaps, update `docs/keymaps.md`, if any external installation is required update `docs/install.md`.  whenver adding/modifying keymaps, make sure there are no conflicts.
