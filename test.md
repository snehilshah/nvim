...
### Motion Diagrams {.break-inside-avoid}
...
### Insert Mode {.break-inside-avoid}
...
### Saving and Exiting {.break-inside-avoid}
...
### Normal Mode {.break-inside-avoid}
...
### Cut and paste {.break-inside-avoid}
...
### Visual mode {.break-inside-avoid}
...
## Vim Operators {.col-span-2}

<div class="two-column">

### Usage {.secondary .break-inside-avoid}
...
### Available Operators {.break-inside-avoid}
...
### Text objects {.break-inside-avoid}
